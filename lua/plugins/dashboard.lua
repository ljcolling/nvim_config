return {
  ...
  config = function()
    ...
    db.custom_center = {
      ...
      { icon = "F ", desc = " Find Word                    ", action = "Telescope live_grep" },
      { icon = " ", desc = " Neovim Config                ", action = "e ~/.config/nvim/init.lua" },
      { icon = " ", desc = " ZSH config                   ", action = "e ~/.zshrc" },
      { icon = "K ", desc = " Kitty config                 ", action = "e ~/.config/kitty/kitty.conf" },
      ...
      { icon = "R ", desc = " Radian History               ", action = "e ~/.radian_history" }
    }
  end
}
